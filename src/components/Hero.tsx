...
const Hero: FC = () => {
  return (
    <section className=" w-[90vw] mx-auto mt-4 lg:mt-[17vh] lg:w-[65vw] 2xl:mt-[22vh] ">
      ...
      <div className="text-slate-600 text-md leading-loose mt-2">
        ...
        <span className="flex">
          View my
          <Link href="/projects" ><span className="mx-2 flex items-center gap-1 cursor-pointer">Projects<BiLinkExternal className="text-[#f70809]"/></span></Link>
          <Link href="/blogs" >
      ...
      <div className="fixed hidden lg:fixed lg:flex lg:flex-col lg:left-[5vw] lg:top-2/4 lg:gap-3">
        <FaLinkedin size={30} />
        <FaTwitter size={30} />
        <FaGithub size={30} />
        <IoMdMail size={30} />
