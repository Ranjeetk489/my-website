...
const Navbar: FC = () => {
    ...
    return (
        <>
            ...
            <div className='flex justify-between items-center mt-3 lg:w-[90vw] mx-auto'>
...
const NavItem: FC<NavItemProps> = ({ children, linkTo }) => {
    return (
        <Link href={linkTo} className="nav-item mt-8 ml-6 first:mt-20 text-lg text-white bg-inherit  md:text-black md:mt-0 md:first:mt-0 lg:mt-0 ">
            {children}
        </Link>
    )
}
